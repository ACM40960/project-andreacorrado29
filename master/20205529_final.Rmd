...
In this short study, we investigate the major climate change phenomenons such as a rainfall amount and temperature over the last century. We find a relation between year and temperature and between temperature and rainfall amount which we exploit to make prediction about the future 50 years behavior. Moreover, we focus our attention to species survival in South Africa in relation to the climate phenomenons. What we found is that the temperature is steeply raising over time and, as it is negatively correlated, the rainfall amount is decreasing. We also find that these phenomenons are associated to the animals evolution in time which, according the estimated model, is decreasing as well. After the model validation, we provide a possible estimation of the species evolution and notice that the may reach only one individual left, as soon as in 15 years time on average.
